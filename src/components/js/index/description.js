    ...
    return (
        <div className={classes.mainDiv}>
            ...
            <div className={`${classes.childDiv} childDiv2 `}  >
                ...
                <img  src={process.env.PUBLIC_URL + "/assets/indexindexPicture2.jpg"} alt="..." className={classes.image} />
            </div>
            <div className={`${classes.childDiv} childDiv3 `} >
                ...
                <img src={process.env.PUBLIC_URL + "/assets/indexindexPicture3.jpg"} alt="..." className={classes.image} />
            </div>
        </div>
    )
}
